...
namespace AnN3x.StyledGUI
{
    public static partial class Styles
    {
        ...
        public static GUIStyle TooltipOverlayStyle => _tooltipOverlayStyle ??= new GUIStyle()
        {
        ...
        public static GUIStyle TooltipContainerStyle => _tooltipContainerStyle ??= new GUIStyle()
        {
        ...
        public static GUIStyle TooltipTextStyle => _tooltipTextStyle ??= new GUIStyle(Graphics.DefaultSkin.FindStyle("Text"))
        {
