...
namespace AnN3x.StyledGUI
{
    public static partial class Styles
    {
        ...
        public static GUIStyle RowStyle { get; set; } =
            new GUIStyle(Graphics.DefaultSkin.FindStyle("PopupWindow.Row"))
            {
        ...
        public static GUIStyle CellStyle { get; set; } =
            new GUIStyle(Graphics.DefaultSkin.FindStyle("PopupWindow.Grid"))
            {
                fontSize = 12,
                normal = new GUIStyleState()
                {
        ...
        public static GUIStyle ColorableCellToggleStyle { get; set; } =
            new GUIStyle(Graphics.DefaultSkin.button)
            {
                fontSize = 12,
                margin = Graphics.DefaultSkin.FindStyle("PopupWindow.Grid").margin,
                padding = Graphics.DefaultSkin.FindStyle("PopupWindow.Grid").padding,
                normal = new GUIStyleState()
                {
                    background = Alpha65WhitePixel,
                    textColor = Color.white
        ...
        public static GUIStyle CellButtonStyle { get; set; } =
            new GUIStyle(Graphics.DefaultSkin.button)
            {
                fontSize = 12,
                margin = Graphics.DefaultSkin.FindStyle("PopupWindow.Grid").margin,
        ...
        public static GUIStyle ToggleCaptureStyle { get; set; } =
            new GUIStyle(Graphics.DefaultSkin.toggle)
            {
                fontSize = 12,
                margin = Graphics.DefaultSkin.FindStyle("PopupWindow.Grid").margin,
                padding = Graphics.DefaultSkin.FindStyle("PopupWindow.Grid").padding,
                ...
                hover = new GUIStyleState()
                {
                    background = Graphics.DefaultSkin.toggle.hover.background,
                    textColor = WhitePearlTextColor
                },
                active = new GUIStyleState()
                {
                    background = Graphics.DefaultSkin.textField.onNormal.background,
